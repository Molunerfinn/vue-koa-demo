    ...
    <div class="home" v-show="ui.homeVisible">
      ...
      <div class="gameInfoBox">
        <div class="titleImg imgContainer absCenter">
          <img id="titleImg" class="slaveImg abs" :src="skinAssets.titleImg" style="width:14.95rem;height:8.6rem;top:-0.05rem;left:0.55rem;"
          />
        </div>
      </div>
...
<script>
  ...
  import { setAchievebycode, postMsg, getGameResult, getRoundState } from '@/api/games/jiaozi'
