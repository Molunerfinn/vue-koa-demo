 ...
 */
export const getGameInfo = (data) => fetch('/gapi/ido/start'+data )
export const getResultInfo = (data) => fetch('/gapi/ido/result', data )
...
export const shareGame = (data) => fetch('/gapi/ido/share', data )
